...
enum Frobenius {
    static let aaaa = Fp(hex: "1a0111ea397fe69a4b1ba7b6434bacd764774b84f38512bf6730d2a0f6b0f6241eabfffeb153ffffb9feffffffffaaaa")
    
    /// Used by `psi2C1` and Fp6 (one and two) and Fp12
    static let aaac = Fp(hex: "1a0111ea397fe699ec02408663d4de85aa0d857d89759ad4897d29650fb85f9b409427eb4f49fffd8bfd00000000aaac")
    
    /// Used by Fp6 and Fp12
    static let aaad = Fp(hex: "1a0111ea397fe699ec02408663d4de85aa0d857d89759ad4897d29650fb85f9b409427eb4f49fffd8bfd00000000aaad")
    
    /// Used by Fp6 one and two
    static let fffe = Fp(hex: "00000000000000005f19672fdf76ce51ba69c6076a0f77eaddb3a93be6f89688de17d813620a00022e01fffffffefffe")
    ...
    static let ffff = Fp(hex: "00000000000000005f19672fdf76ce51ba69c6076a0f77eaddb3a93be6f89688de17d813620a00022e01fffffffeffff")
    
    /// used by Fp12
    static let fb8 = Fp(hex: "1904d3bf02bb0667c231beb4202c0d1f0fd603fd3cbd5f4f7b2443d784bab9c4f67ea53d63e7813d8d0775ed92235fb8")
    
    /// used by Fp12
    static let af3 = Fp(hex: "00fc3e2b36c4e03288e9e902231f9fb854a14787b6c7b36fec0c8ec971f63c5f282d5ac14d6c7ec22cf78a126ddc4af3")

    /// used by Fp12
    static let e980078116 = Fp(hex: "05b2cfd9013a5fd8df47fa6b48b1e045f39816240c0b8fee8beadf4d8e9c0566c63a3e6e257f87329b18fae980078116")
    
    /// used by Fp12
    static let f82995 = Fp(hex: "144e4211384586c16bd3ad4afa99cc9170df3560e77982d0db45f3536814f0bd5871c1908bd478cd1ee605167ff82995")
    
    /// used by Fp12
    static let dea2 = Fp(hex: "135203e60180a68ee2e9c448d77a2cd91c3dedd930b1cf60ef396489f61eb45e304466cf3e67fa0af1ee7b04121bdea2")
    
    /// used by Fp12
    static let cc09 = Fp(hex: "06af0e0437ff400b6831e36d6bd17ffe48395dabc2d3435e77f76e17009241c5ee67992f72ec05f4c81084fbede3cc09")
...
extension Fp6 {
    ...
    func squared() -> Self {
        ...
        return Self(
            c0: (t3 + t3).mulByNonresidue() + t0, // T3 * (u + 1) + T0
            c1: t4.mulByNonresidue() + t1 + t1, // T4 * (u + 1) + T1
            
            // T1 + (c0 - c1 + c2)² + T3 - T0 - T4
            c2: t1 + t1 + (c0 - c1 + c2).squared() + t3 + t3 - t0 - t4
        )
    }
